...
public class ButtonPerson extends Button implements Serializable {
    ...
    /**
     * Indicates if there are more people in the room that can be handled by its ButtonPersons. If
     * true, the Button changes function, and instead of selecting one person, pups up a list of
     * everyone currently in the Room, so the user can choose one.
     */
